...
//// validators function of function
            ...
            <div className="container">
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
                        <h5>Our Address</h5>
                        <address>
                        70 Park Street, Enterprise<br />
                    East Coast Demerara<br />
                    Guyana, South America<br />
                            <i className="fa fa-phone"></i>: +992 7854 8967<br />
                            <i className="fa fa-envelope"></i>: <a href="mailto:confusion@food.net">playland@gmail.com</a>
                        </address>
                    </div>
